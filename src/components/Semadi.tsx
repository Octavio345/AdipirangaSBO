  ...
  return (
    <section id="semadi" className="py-20 bg-gradient-to-b from-white to-blue-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                ...
                description: "Apoio a missionários em regiões carentes do Brasil com evangelismo e ação social.",
                highlight: "Amazônia, Nordeste, Comunidades Indígenas"
              },
              {
                icon: "✈️",
                title: "Missões Internacionais",
                description: "Envio de missionários para países de língua portuguesa e outras nações.",
                highlight: "África, América Latina"
              },
              {
                icon: "🎓",
                title: "Formação Missionária",
                description: "Treinamento prático e teórico na base missionária em Itatiba-SP.",
                highlight: "Curso Básico e Avançado"
              },
              {
                icon: "🤝",
                title: "Acompanhamento",
                description: "Suporte espiritual e logístico para famílias missionárias.",
                highlight: "Sustento e Assistência"
              },
              {
                icon: "📚",
                title: "Capacitação",
                description: "Preparação doutrinária e prática para obreiros em campos missionários.",
                highlight: "Teologia e Missiologia"
              },
              {
                icon: "❤️",
                title: "Projetos Sociais",
                description: "Ações humanitárias integradas ao trabalho evangelístico.",
                highlight: "Ação Social e Evangelismo"
              }
            ].map((item, index) => (
              <div 
                key={index} 
                className="bg-white rounded-xl p-6 shadow-md border border-slate-100 hover:shadow-lg hover:border-blue-200 transition-all duration-300"
              >
                ...
                <div className="pt-3 border-t border-slate-100">
                  <p className="text-sm font-semibold text-blue-700">{item.highlight}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* CTA Principal - Site Oficial */}
        <div className="text-center mb-16">
          <div className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-2xl p-10 shadow-xl text-white">
            <h3 className="text-2xl font-bold mb-4">
              Tudo o que você precisa saber sobre a SEMADI
            </h3>
            <p className="text-blue-200 mb-6 max-w-2xl mx-auto">
              No site oficial você encontrará informações completas sobre:
              contribuições, projetos ativos, missionários em campo, formulários de inscrição, 
              calendário de eventos e muito mais.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-6">
              {[
                ...
                <span 
                  key={idx}
                  className="px-4 py-2 bg-blue-700/50 text-white rounded-full text-sm font-medium"
                >
                  {item}
                </span>
              ))}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-gradient-to-r from-yellow-500 to-yellow-600 text-blue-900 font-bold px-8 py-4 rounded-full hover:from-yellow-600 hover:to-yellow-700 transition-all duration-300 hover:scale-105 shadow-lg text-lg"
            >
            ...
            <p className="text-blue-300 text-sm mt-4">
              Todo suporte, contribuições e inscrições são feitas através do site oficial
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-blue-100">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-5 bg-blue-50 rounded-xl border border-blue-100">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="font-bold text-blue-800">Contato Oficial</h4>
              </div>
              <p className="text-slate-700">
                Para informações oficiais sobre a SEMADI, visite nosso site onde você encontrará:
              </p>
              <ul className="mt-3 space-y-2 text-sm text-slate-600">
                <li>• Formulários de contato oficiais</li>
                <li>• E-mails departamentais</li>
                <li>• Telefones específicos</li>
            ...
            <div className="p-5 bg-blue-50 rounded-xl border border-blue-100">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="font-bold text-blue-800">Como Participar</h4>
              </div>
              <p className="text-slate-700">
                No site oficial você pode:
              </p>
              <ul className="mt-3 space-y-2 text-sm text-slate-600">
                <li>• Tornar-se mantenedor de missionários</li>
                <li>• Participar do grupo de intercessão</li>
                <li>• Inscrever-se como voluntário</li>
                <li>• Acompanhar projetos ativos</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-blue-100 text-center">
            <p className="text-slate-600">
              <strong>Nota:</strong> Todas as operações, contribuições e comunicações oficiais 
              da SEMADI são realizadas através do site oficial para melhor organização e transparência.
            </p>
          </div>
        </div>
